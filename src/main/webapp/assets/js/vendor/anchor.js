...
function AnchorJS(options) {
  ...
  this._addBaselineStyles = function() {
    // We don't want to add global baseline pages.styles if they've been added before.
    ...
    // not look out of place. We insert before the others so these pages.styles can be
